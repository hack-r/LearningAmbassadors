...
public class GameView extends JFrame{
	...
	public GameView() {
		...
		orderLabel = new JLabel("Read Help -> Game Rules");
		...
		equationLabel = new JLabel("Click here \"New Game\"");
	...
	public void showGameScore(double gameScore) {
		JOptionPane.showMessageDialog(gamePanel, "Results: "+gameScore, "Good game!!!", JOptionPane.INFORMATION_MESSAGE);
